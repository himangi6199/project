...
public class project extends JFrame implements ActionListener {
    ...
    project(){
     ...
     util.setFont(new Font("monospaced",Font.PLAIN,25));
        mb.add(util);
        ...
        u1.setFont(new Font("monospaced",Font.PLAIN,20));
        u1.setMnemonic('o');
        ...
        u2.setFont(new Font("monospaced",Font.PLAIN,20));
        u2.setMnemonic('C');
        ...
        u3.setFont(new Font("monospaced",Font.PLAIN,20));
        u3.setMnemonic('E');
        ...
        m8i1.setFont(new Font("monospaced", Font.PLAIN, 25));
        m8i1.setMnemonic('X');
